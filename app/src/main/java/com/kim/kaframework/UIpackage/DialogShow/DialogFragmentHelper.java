package com.kim.kaframework.UIpackage.DialogShow;
...
public class DialogFragmentHelper {
    ...
    public static void showIntervalInsertDialog(FragmentManager manager, final String title, final IDialogResultListener<String []> resultListener, final boolean cancelable){
        CommonDialogFragment dialogFragment = CommonDialogFragment.newInstance(new CommonDialogFragment.OnCallDialog() {
            @Override
            public Dialog getDialog(Context context) {
                View view = LayoutInflater.from(context).inflate(R.layout.dialogfragment_edit_name, null);
                final EditText minEditText = (EditText) view.findViewById(R.id.editdialog_username);
                final EditText maxEditText = (EditText) view.findViewById(R.id.editdialog_password);
