...
public class UserInfoDao extends AbstractDao<UserInfo, Long> {
    ...
    public static class Properties {
        ...
        public final static Property UPost = new Property(2, String.class, "UPost", false, "UPOST");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, UserInfo entity) {
        ...
        String UPost = entity.getUPost();
        if (UPost != null) {
            stmt.bindString(3, UPost);
        }
    }
    ...
    public UserInfo readEntity(Cursor cursor, int offset) {
        UserInfo entity = new UserInfo( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // UPost
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, UserInfo entity, int offset) {
        ...
        entity.setUPost(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
